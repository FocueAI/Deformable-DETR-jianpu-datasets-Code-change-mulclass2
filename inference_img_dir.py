...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='weight_result_6_7/checkpoint0359.pth', help='resume from checkpoint')
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--imgs_dir', default='./data/coco/val2017',type=str, help='input images folder for inference')
...
def main(args):
    ...
    for img_file in os.listdir(args.imgs_dir):
        ...
        out_imgName = './visualize_2023_6_7_1/'+'out_'+img_file[:-4]+'.png'
        ...
        for  box_coord, label_index in zip(boxes[0].tolist(),labels.tolist()):
